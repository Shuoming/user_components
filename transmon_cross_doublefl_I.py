...
from qiskit_metal.qlibrary.user_components.transmon_cross_I import TransmonCrossBetterI


class TransmonCrossTwoFLI(TransmonCrossBetterI):  # pylint: disable=invalid-name
...
#####################################################################
    ...
    def make_flux_line(self):
        ...
        parts = draw.translate(
            parts, 0, -(p.cross_length/p.tr + p.cross_gap + pf.t_inductive_gap +
